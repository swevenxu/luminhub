...
export default function HomePage() {
  ...
  const [tilt, setTilt] = useState({ x: 2, y: -5 }); // initial 3D position
  ...
  const handleMouseLeave = () => {
    setTilt({ x: 2, y: -5 }); // back to original 3D position
  };
  return (
    <>
      <Navbar />
        ...
        <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-32 pt-20 md:pt-32 lg:pt-40 relative z-10">
          <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div 
              ...
              className="flex flex-col items-center justify-center lg:order-last w-full cursor-pointer"
            >
              <Image
                src="/hero-image.png"
                alt="Hero Image"
                width={600}
                height={400}
                className="rounded-lg w-full max-w-[250px] sm:max-w-[320px] md:max-w-[400px] lg:max-w-full h-auto transition-transform duration-200 ease-out"
                style={{
                  boxShadow:
                    "10px 10px 0px rgba(0, 0, 0, 0.3), 20px 20px 0px rgba(0, 0, 0, 0.2), 30px 30px 0px rgba(0, 0, 0, 0.1)",
            ...
            <div className="text-white text-center lg:text-left">
              <h1
                ...
                style={{
                  ...
                  textShadow:
                    "1px 1px 2px rgba(41, 2, 66, 0.8), 2px 2px 4px rgba(41, 2, 66, 0.6), 3px 3px 6px rgba(41, 2, 66, 0.4), 4px 4px 8px rgba(0, 0, 0, 0.8), 0 0 20px rgba(41, 2, 66, 0.5)",
                  filter: "drop-shadow(0 4px 8px rgba(41, 2, 66, 0.3))",
                }}
              >
                The only hub
                <br />
                <span style={{ color: "#8f21d1" }}>you need.</span>
              </h1>
              <p
                className="text-sm sm:text-base md:text-lg text-gray-300 mb-4 md:mb-6 px-4 sm:px-0"
                style={{ fontFamily: "'Bespoke Sans', sans-serif" }}
              >
                Premium Roblox scripts for your favorite games. Fast, reliable,
                and always updated.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 max-w-[300px] sm:max-w-none mx-auto">
            ...
            >
              <div className="aspect-square relative">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <h3
                    className="text-xl font-bold text-white uppercase text-center"
                    style={{ fontFamily: "'Khand', sans-serif" }}
                  >
                    GROW A GARDEN
                  </h3>
